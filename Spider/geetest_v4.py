...
async def main(kwyword, url):  # 定义main协程函数，
    ...
    await page.type('#keyword input', kwyword, {'delay': input_time_random()})
...
if __name__ == '__main__':
    kwyword = '微信'  # 淘宝用户名
    url = "http://www.gsxt.gov.cn/index"
    loop = asyncio.get_event_loop()  # 协程，开启个无限循环的程序流程，把一些函数注册到事件循环上。当满足事件发生的时候，调用相应的协程函数。
    loop.run_until_complete(main(kwyword, url))
